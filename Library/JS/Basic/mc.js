 ...
 * @param {(player:Player,cmd:string)} callback 事件回调
 * @returns {boolean} 是否添加成功
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,msg:string)} callback 事件回调
 * @returns {boolean} 是否添加成功
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,entity:Entity)} callback 事件回调
 * @returns {boolean} 是否添加成功
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,item:Item,block:Block)} callback 事件回调
 * @returns {boolean} 是否添加成功
 */
 static listen(event,callback)
 ...
 * @param {(player:Player,pos:IntPos)} callback 事件回调
 * @returns {boolean} 是否添加成功
 */
 static listen(event,callback)
